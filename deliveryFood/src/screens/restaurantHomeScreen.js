...
const RestaurantHomeScreen = ({navigation, route}) =>{
    ...
    const renderTabBar = props =>(
        <TabBar
            {...props}
            indicatorStyle = {{backgroundColor:colors.headersText}}
                ...
                <View>
                    ...
                    <View style={styles.view2}>
                        <View style={styles.view3}>
                            ...
                            <Icon name ="star" type ="material-community" color = {colors.grey4} size = {15} />
                            ...
                            <Icon name ="map-marker" type ="material-community" color = {colors.grey4} size = {15} />
